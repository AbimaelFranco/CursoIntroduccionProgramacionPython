...
# Cargar imagen del jugador con manejo de error
player_size = 60  # tamaño del hitbox
try:
    player_image = pygame.image.load(os.path.join(current_dir, "player.png"))
    player_image = pygame.transform.scale(player_image, (player_size, player_size))
except:
    print("No se pudo cargar la imagen del jugador, usando rectángulo rojo.")
    player_image = None

# Cargar imagen de fondo con manejo de error
try:
...
def game_loop():
    ...
    # Función interna para crear obstáculos
    def create_obstacle():
        x = random.randint(0, WIDTH - obstacle_width)
        y = -obstacle_height
        obstacles.append(pygame.Rect(x, y, obstacle_width, obstacle_height))

    # Función interna para partículas
